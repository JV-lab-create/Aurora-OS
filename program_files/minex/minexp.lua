...
-- Stores settings api files in '/program_files/minex/' and deleted files in '/recycle_bin/' Configurable. 
...
recycleDir = "/recycle_bin/"
cfgDir = "/program_files/minex/"
...
if not fs.exists(cfgDir.."colors.cfg") then
	...
	settings.save("/program_files/minex/colors.cfg")
	settings.clear()
end
if not fs.exists(cfgDir.."programs.cfg") then
	...
	settings.save("/program_files/minex/programs.cfg")
	settings.clear()
end
...
--local selectColor = colors.lightBlue
